...
/* BUTTON */
+function(t){"use strict";function e(e){return this.each(function(){var n=t(this),o=n.data(OCF_PREFIX+".button"),s="object"==typeof e&&e;o||n.data(OCF_PREFIX+".button",o=new i(this,s)),e&&o.setState(e)})}var i=function(e,n){this.$element=t(e),this.options=t.extend({},i.DEFAULTS,n),this.isLoading=!1};i.DEFAULTS={loadingText:"loading..."},i.prototype.setState=function(e){console.log("[OCFilter] setState:", e);var i=OCF_PREFIX+"-disabled",n="disabled",o=this.$element,s=o.is("input")?"val":"html",a=o.data();e+="Text",null==a.resetText&&o.data("resetText",o[s]()),setTimeout(t.proxy(function(){if("loadingText"==e&&o.data("_ocf_resp")){console.log("[OCFilter] setState: skip loading - response already received");return;}o[s](null==a[e]?this.options[e]:a[e]),"loadingText"==e?(this.isLoading=!0,o.addClass(i).attr(n,n).prop(i,!0)):this.isLoading&&(this.isLoading=!1,o.removeClass(i).removeAttr(n).prop(i,!1))},this),0)},t.fn[OCF_PREFIX+"Button"]=e,t.fn[OCF_PREFIX+"Button"].Constructor=i}(jQuery);
...
+function($) {
  ...
  OCFilter.prototype.search = function($value, filter_key) {
    ...
    console.log("[OCFilter] search() url=", url, "data=", JSON.stringify(data), "searchBtn=", that.options.searchButton);
    that.$button.data('_ocf_resp', false);
    $.get(url, data, function(json) {
      that.$button.data('_ocf_resp', true);
      console.log("[OCFilter] $.get OK: total=", json.total, "href=", (json.href||"").slice(0,80));
      clearTimeout(timer);
      ...
      console.error('[OCFilter] $.get FAILED: status='+status+' err='+err+' httpStatus='+xhr.status);
