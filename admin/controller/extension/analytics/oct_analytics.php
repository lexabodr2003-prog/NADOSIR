...
class ControllerExtensionAnalyticsOCTAnalytics extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/analytics/oct_analytics', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . (int)$this->request->get['store_id'], true)
		];

		$data['action'] = $this->url->link('extension/analytics/oct_analytics', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . (int)$this->request->get['store_id'], true);
		...
		if (isset($this->request->post['analytics_oct_analytics_status'])) {
			...
			$data['analytics_oct_analytics_status'] = $this->model_setting_setting->getSettingValue('analytics_oct_analytics_status', (int)$this->request->get['store_id']);
		}
		...
		if (isset($this->request->post['analytics_oct_analytics_position'])) {
			...
			$data['analytics_oct_analytics_position'] = $this->model_setting_setting->getSettingValue('analytics_oct_analytics_position', (int)$this->request->get['store_id']);
		}
		...
		if (isset($this->request->post['analytics_oct_analytics_targets'])) {
			...
			$data['analytics_oct_analytics_targets'] = json_decode($this->model_setting_setting->getSettingValue('analytics_oct_analytics_targets', (int)$this->request->get['store_id']));
		}
		...
		if (isset($this->request->post['analytics_oct_analytics_google_status'])) {
			...
			$data['analytics_oct_analytics_google_status'] = $this->model_setting_setting->getSettingValue('analytics_oct_analytics_google_status', (int)$this->request->get['store_id']);
		}
		...
		if (isset($this->request->post['analytics_oct_analytics_google_code'])) {
			...
			$data['analytics_oct_analytics_google_code'] = $this->model_setting_setting->getSettingValue('analytics_oct_analytics_google_code', (int)$this->request->get['store_id']);
		}
		...
		if (isset($this->request->post['analytics_oct_analytics_googleads_code'])) {
			...
			$data['analytics_oct_analytics_googleads_code'] = $this->model_setting_setting->getSettingValue('analytics_oct_analytics_googleads_code', (int)$this->request->get['store_id']);
		}
		...
		if (isset($this->request->post['analytics_oct_analytics_googletm_code'])) {
			...
			$data['analytics_oct_analytics_googletm_code'] = $this->model_setting_setting->getSettingValue('analytics_oct_analytics_googletm_code', (int)$this->request->get['store_id']);
		}
		...
		if (isset($this->request->post['analytics_oct_analytics_google_webmaster_code'])) {
			...
			$data['analytics_oct_analytics_google_webmaster_code'] = $this->model_setting_setting->getSettingValue('analytics_oct_analytics_google_webmaster_code', (int)$this->request->get['store_id']);
		}
		...
		if (isset($this->request->post['analytics_oct_analytics_google_ecommerce'])) {
			...
			$data['analytics_oct_analytics_google_ecommerce'] = $this->model_setting_setting->getSettingValue('analytics_oct_analytics_google_ecommerce', (int)$this->request->get['store_id']);
		}
