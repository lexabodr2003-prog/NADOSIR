...
class ControllerExtensionThemeOCTDeals extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->get['store_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			...
			$setting_info['theme_oct_deals_license'] = $this->l__d9c626d0d93d95fec63074f2e946e04c($this->request->server['HTTP_HOST']);
		}
	...
	public function octInstallEvents() {
		...
		$events = [
			...
			[
				'code' => 'octemplates-deals-order-status-notify',
				'trigger' => 'catalog/model/checkout/order/addOrderHistory/after',
				'action' => 'octemplates/events/sms_notify/orderStatusNotify'
			]
		];
	...
	public function octUninstallEvents() {
		...
		$eventCodes = [
			...
			'octemplates-deals-order-status-notify'
		];
	...
	public function update() {
		...
		$this->model_octemplates_main_oct_settings->installAuthRateLimit();
		$this->model_octemplates_main_oct_settings->installShortAbandonedLink();
