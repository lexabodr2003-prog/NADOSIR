...
class ControllerOCTemplatesModuleOctPopupFoundCheaper extends Controller {
    ...
    public function history() {
        ...
        $pagination->limit = 20;
        $pagination->url   = $this->url->link('octemplates/module/oct_popup_found_cheaper/history', 'user_token=' . $this->session->data['user_token'] . '&page=' . urlencode('{page}'), true);
    ...
    public function history_add_processed() {
        ...
        $results = $this->model_octemplates_module_oct_popup_found_cheaper->addProcessed((int)$this->request->get['request_id'], (int)$this->request->get['processed_status']);
