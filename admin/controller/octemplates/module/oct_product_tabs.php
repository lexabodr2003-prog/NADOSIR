...
class ControllerOCTemplatesModuleOctProductTabs extends Controller {
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_octemplates_module_oct_product_tabs->editProductTab((int)$this->request->get['extra_tab_id'], $this->request->post);
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $extra_tab_id) {
                $this->model_octemplates_module_oct_product_tabs->deleteProductTab((int)$extra_tab_id);
            }
    ...
    protected function getList() {
        ...
        if (isset($this->request->get['sort'])) {
            $sort = urlencode($this->request->get['sort']);
        } else {
            $sort = 'id.title';
        }
        
        if (isset($this->request->get['order'])) {
            $order = urlencode($this->request->get['order']);
        } else {
            $order = 'ASC';
        }
        ...
        foreach ($results as $result) {
            $data['oct_product_tabs'][] = [
                ...
                'edit' => $this->url->link('octemplates/module/oct_product_tabs/edit', 'user_token=' . $this->session->data['user_token'] . '&extra_tab_id=' . (int)$result['extra_tab_id'] . $url, true)
            ];
        }
    ...
    protected function getForm() {
        ...
        if (!isset($this->request->get['extra_tab_id'])) {
            ...
            $data['action'] = $this->url->link('octemplates/module/oct_product_tabs/edit', 'user_token=' . $this->session->data['user_token'] . '&extra_tab_id=' . (int)$this->request->get['extra_tab_id'] . $url, true);
        }
        ...
        if (isset($this->request->get['extra_tab_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $oct_product_tabs_info = $this->model_octemplates_module_oct_product_tabs->getProductTab((int)$this->request->get['extra_tab_id']);
        }
        ...
        if (isset($this->request->post['oct_product_tabs_description'])) {
            ...
            $data['oct_product_tabs_description'] = $this->model_octemplates_module_oct_product_tabs->getProductTabsDescriptions((int)$this->request->get['extra_tab_id']);
        } else {
