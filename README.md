...
## Деплой (28.02.2026) — Prompt 11: Обновление цен из прайс-листа

### Что было сделано

#### П.14/20 — Обновление цен и ассортимента
- Загружен и обработан прайс-лист **7.Прайс для сайта.xlsx** (183 товара) ✅
- Все цены в `oc_product` обновлены по розничным ценам из прайс-листа ✅
- Формат: SQL CASE UPDATE по полю `model` ✅
- Модуль `featured.28` обновлён с 2 дешевейшими товарами из каждой серии после обновления цен ✅

#### Новые цены (выборка):
| Модель | Старая цена | Новая цена |
|--------|------------|------------|
| ЭЦВ 4-2,5-30 | 11 999 | 13 500 |
| ЭЦВ 4-1,5-40 | 12 999 | 13 900 |
| ЭЦВ 5-4-75 | 38 999 | 42 600 |
| ЭЦВ 6-4-70 | 42 999 | 47 000 |
| ЭЦВ 8-40-40 | 54 999 | 78 400 |

#### Товары на главной (после обновления цен):
- ЭЦВ 4-2,5-30, ЭЦВ 4-1,5-40 (серия 4)
- ЭЦВ 5-4-75, ЭЦВ 5-4-80 (серия 5)
- ЭЦВ 6-6,5-60, ЭЦВ 6-6,5-75 (серия 6)
- ЭЦВ 8-25-55, ЭЦВ 8-16-85 (серия 8)
- ЭЦВ 10-65-65, ЭЦВ 10-65-65 нрк (серия 10)
